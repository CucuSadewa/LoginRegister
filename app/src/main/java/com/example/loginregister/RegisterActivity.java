...
public class RegisterActivity extends AppCompatActivity {
    ...
    private static String URL_REGISTER = "http://3jnc.tech/animepedia/api/loginandroid/register.php";
    SessionManager sessionManager;

    //    menggunakan hostingan berikut dengan databasenya:
//    URL_REGISTER = "http://3jnc.tech/animepedia/api/loginandroid/register.php"
